...
- **Right button** switches pages: Channels, Settings and Raw inputs.
...
Active channels are on light gray background. Inactive channels have dark gray backround. 
...
- Select a channel with 5-way joystick by pressing it up or down;
- Enter channel edit page by pressing the joystick.

#### Channel edit page

Note: To edit a channel you have to have at least one input device connected to RCHub (USB or Bluetooth).

- Navigate channel options by using the 5-way joystick, up or down;  
- Activate an option by pressing on the joystick;  
- Edit option value by pressing up or down;  
- Finish editing an option by pressing on the joystick again;  
- Return to the main page by selecting "Save & Back..." line and pressing on the 5-way joystick.

### Raw device view page

This page shows raw data received from a connected device: for USB controllers these are axes and buttons, for Bluetooth trainer these are channels.  
Switch between raw and normalised value views with the 5-way joystick, left or right.  
